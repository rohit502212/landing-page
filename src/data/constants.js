...
export const experiences = [
  {
    id: 0,
    img: "https://cdn.prod.website-files.com/5ec7dad2e6f6295a9e2a23dd/6501cd1441abd1a4ab2c9aa8_624cdc2355d250b5095255f1_What-is-freelancing-p-1080.jpg",
    role: "Front-end Engineer",
    company: "Freelancing",
    date: "May 2024 - Present",
    desc: "Platform development, user gaming platform, game deployment, payment system integration, logging system, user activity tracking..",
    skills: [
      "React Js",
      "Javascript",
      "Redux",
  ...
  },
  {
    ...
    company: "Megitech Innovision LLP",
...
export const projects = [
  {
    ...
    date: "May 2024 - Present",
    description:
      "Designed and developed the GameHub project, Developed a gaming platform with features for easy game deployment, notifications, payment integration, and logging. Designed an admin dashboard for user activity tracking and active user monitoring.",
    image:
  ...
  },
  {
    ...
    description:
      "A secure photo-sharing platform enabling user authentication, photo uploads, and customizable access policies.",
    image:
  ...
  //   description:
  //     "Built Anraag's finance portal UI with ReactJS and Tailwind CSS, securing the backend with Node.js, Express.js, and MongoDB for authenticated access and transaction capabilities. ",
  //   image:
